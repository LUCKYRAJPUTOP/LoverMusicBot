...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯𝗟𝗼𝘃𝗲𝗿✯=🔄 Processing... Song")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        await res.edit_text(f"✯𝗟𝗼𝘃𝗲𝗿✯=#️⃣ Queued at position {position}.")
    else:
        await res.edit_text("✯𝗟𝗼𝘃𝗲𝗿✯=▶️ Playing... Song")
        res.delete
        m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="Others/thumbnail2.png",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Support⚡️", url="https://t.me/LoverMusicSupport")]]
        ),
        caption=f"Playing Your song Via  [✯𝗟𝗼𝘃𝗲𝗿✯](https://t.me/LoverMusicSupport).",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        ...
        caption=f"Playing [{title}]({url}) Via [Deezer](https://t.me/LoverMusicSupport)."
    ) 
    os.remove("final.png")
# -----------------------------------------------------Jiosaavn-----------------------------------------------------------------
@Client.on_message(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [Jiosaavn](https://t.me/LoverMusicSupport)",
        photo="final.png",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Support⚡️", url="https://t.me/LoverMusicSupport")]]
        ),
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [YouTube](https://t.me/LoverMusicSupport)",
        photo="final.png",
        reply_markup=InlineKeyboardMarkup(
